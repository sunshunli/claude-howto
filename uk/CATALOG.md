...
| `/reload-plugins` | Перезавантажити плагіни. Починаючи з v2.1.221 більшість установок активуються одразу; команда потрібна лише коли підсумок установки каже `Run /reload-plugins to activate.` | Управління плагінами |
