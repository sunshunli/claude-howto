...
Цей файл доповнює кореневий CLAUDE.md для всього у /src/api/. Файли пам'яті
конкатенуються, а не перевизначаються — кореневий CLAUDE.md продовжує діяти, а Claude Code
завантажує цей файл за потреби, коли читає файли в цьому піддереві.
